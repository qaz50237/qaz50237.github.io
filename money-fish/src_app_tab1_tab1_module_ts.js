...
const data = {
    ...
    records: {
        dataid: 'F-A0021-001',
        note: '潮汐預報(未來1個月潮汐預報，鄉鎮、大潮小潮、滿潮乾潮、時間、潮高)',
        location: [
            {
                locationName: '臺南市安南區',
                stationId: '67000350',
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/core */ 3184);
/* harmony import */ var ng2_charts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ng2-charts */ 4195);
/* harmony import */ var _mock__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./mock */ 9967);
/* harmony import */ var chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! chartjs-plugin-datalabels */ 9007);
...
let Tab1Page = class Tab1Page {
    constructor() {
        ...
        this.barChartPlugins = [
            chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_3__["default"]
        ];
        this.barChartData = {
        ...
        let F_labels = [];
        let F_data = [];
        _mock__WEBPACK_IMPORTED_MODULE_2__.data.records.location[0].validTime.forEach(validTimes => {
            let dayValues = validTimes.weatherElement.find(o => o.elementName === '1日潮汐');
            dayValues.time.forEach(times => {
                F_labels.push(times.dataTime);
                F_data.push(times.parameter.find(o => o.parameterName === '潮高(當地)').parameterValue);
            });
        });
        console.log('F_labels: ', F_labels);
        console.log('F_data: ', F_data);
        this.barChartData.labels = F_labels;
        this.barChartData.datasets = [{ data: F_data, label: 'test' }];
    }
    // events
...
Tab1Page.propDecorators = {
    chart: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_4__.ViewChild, args: [ng2_charts__WEBPACK_IMPORTED_MODULE_5__.BaseChartDirective,] }]
};
...
/* harmony export */ });
/* harmony import */ var _chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunks/helpers.segment.js */ 2207);
/*!
 * Chart.js v3.7.1
...
/* harmony export */ });
/* harmony import */ var _dist_helpers_esm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../dist/helpers.esm */ 6169);
...
/* harmony export */ });
/* harmony import */ var chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! chart.js/helpers */ 3407);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _baseIsArguments_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_baseIsArguments.js */ 2835);
